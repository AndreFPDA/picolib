...
/*!
    ...
    @return SSD1306I2CPICO object.
*/
SSD1306I2CPICO::SSD1306I2CPICO(uint16_t const DevAddr, OLEDDISPLAY_GEOMETRY GEOMETRY, i2c_inst_t * i2c) //: DevAddr(DevAddr), width(width), height(height), i2c(i2c), OLEDDISPLAY_GEOMETRY(GEOMETRY)
{
	this->width = 128;
	this->height = 64;
 ...
 *
 */
void SSD1306I2CPICO::sendCommand(uint8_t command)
{	
 ...
 *
 */
void SSD1306I2CPICO::invertColors(uint8_t Invert)
{
 ...
 *
 */
void SSD1306I2CPICO::rotateDisplay(uint8_t Rotate)
{
 ...
 * 1 – Turn ON
 */
void SSD1306I2CPICO::displayON(uint8_t On)
{
 ...
 *
 */
void SSD1306I2CPICO::setContrast(uint8_t Contrast)
{
...
/*
void SSD1306I2CPICO::drawPixel(int16_t x, int16_t y, colors Color)
{
 ...
 */
/*
void SSD1306I2CPICO::clear(colors Color)
{
	switch (Color)
	{
		case colors::WHITE:
...
/*void SSD1306I2CPICO::display(unsigned char *data)
{
...
void SSD1306I2CPICO::sendData(uint8_t* buffer, size_t buff_size)
{
 ...
 */
uint8_t SSD1306I2CPICO::getHeight()
{
	if(this->GEOMETRY == OLEDDISPLAY_GEOMETRY::GEOMETRY_128_64) return 64;
	else return 32;
}
 ...
 */
uint8_t SSD1306I2CPICO::getWidth()
{
	return this->width;
}