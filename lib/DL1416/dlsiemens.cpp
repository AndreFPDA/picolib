...
//=================================================================================================
DLSIEMENS::DLSIEMENS(const std::vector<int>& modulos, int wri,
           int ds0, int ds1, int d0, int d1, int d2,
    ...
    _dataCode({d0, d1, d2, d3, d4, d5, d6})
{
   ...
   const std::array<std::pair<char, int>, 64> charset_init = {{
        {'!', 0b0100001}, {' ', 0b0100000}, {'"', 0b0100010}, {'#', 0b0100011},
        {'$', 0b0100100}, {'%', 0b0100101}, {'&', 0b0100110}, {'\'', 0b0100111},
        {'(', 0b0101000}, {')', 0b0101001}, {'*', 0b0101010}, {'+', 0b0101011},
        {',', 0b0101100}, {'-', 0b0101101}, {'.', 0b0101110}, {'/', 0b0101111},
        {'0', 0b0110000}, {'1', 0b0110001}, {'2', 0b0110010}, {'3', 0b0110011},
        {'4', 0b0110100}, {'5', 0b0110101}, {'6', 0b0110110}, {'7', 0b0110111},
        {'8', 0b0111000}, {'9', 0b0111001}, {':', 0b0111010}, {';', 0b0111011},
        {'<', 0b0111100}, {'=', 0b0111101}, {'>', 0b0111110}, {'?', 0b0111111},
        {'@', 0b1000000}, {'A', 0b1000001}, {'B', 0b1000010}, {'C', 0b1000011},
        {'D', 0b1000100}, {'E', 0b1000101}, {'F', 0b1000110}, {'G', 0b1000111},
        {'H', 0b1001000}, {'I', 0b1001001}, {'J', 0b1001010}, {'K', 0b1001011},
        {'L', 0b1001100}, {'M', 0b1001101}, {'N', 0b1001110}, {'O', 0b1001111},
        {'P', 0b1010000}, {'Q', 0b1010001}, {'R', 0b1010010}, {'S', 0b1010011},
        {'T', 0b1010100}, {'U', 0b1010101}, {'V', 0b1010110}, {'W', 0b1010111},
        {'X', 0b1011000}, {'Y', 0b1011001}, {'Z', 0b1011010}, {'[', 0b1011011},
        {'\\', 0b1011100}, {']', 0b1011101}, {'^', 0b1011110}, {'_', 0b1011111}
    }};
...
//==============================================================================================================================================
void DLSIEMENS::characterSet(const char& character, const int& digit, const int& ModuleDisplay) {
